...
The following blogs incorporate "runable" [Python](https://www.python.org/) scripts organized as [Jupyter](https://jupyter.org/) notebooks. Introduction to using these and other amazingly productive, state-of-the-art tools is well beyond our limited scope here. 
