...
We also outline an introductory sampling of analytics. As the end-results are all reproducible, traceable and verifiable numeric quantities, standard data-mining and "big-data" practices can be applied. We end the blogs with presenting just such a "data-mined" report, based on actual filed documents and Court proceedings.
