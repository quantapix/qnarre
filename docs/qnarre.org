...
through adjusting our helper to print the results
...
Before any of our simulations can be tried, or repeated with 
changed parameters, our environment needs to be initialized
...
*** Underlying Classes (or concepts/terms)

*** Modeling the Domain

| Term          | Definition                             | Properties                              | Mark |
| ---           | ---                                    | ---                                     | ---  |
...
| **Doc**       | a unit of paginated flat text Evidence | name (date), kind, author, title, pages |      |
| **Place**     | a specific location in a Doc           | doc, page, para(graph)                  |      |
| **Claim**     | a now Placed relevant text fragment    | text, place                             | '~'  |
| **Author**    | an author of Docs of Claims            | name, title                             |      |
| **Agent**     | a to be believed professional (Author) | kind (of profession)                    |      |
...
| ---           | ---                                                                           | ---         |
| **Topic**     | a relevant/dominant thematic subject matter of Claims                         | name        |
| **Narrative** | a thematically focused "slice" through Claims                                 | name, topic |
| **Kind**      | level of "officialness" (e.g. affidavit, report, letter, motion, order, etc.) | name        |
...
| **Proof**    | a readily verifiable undisputed Claim from an Authority          | claim, authority     | '!p'  |
| **Reality**  | a logical inference from Proofs guided by thematic Claims        | proofs, claims       | '!r'  |
| **Conflict** | a Claim intended to fabricate/escalate bases of Judgments        | claim, reality       | '?.'  |
| **Suborn**   | a false Claim caused by Agent as intentional perjury             | (agent's) agency     | '??.' |
| **Repeat**   | variant of conflict inducing Claim to reinforce intended effect  | claim, conflict      | '^t'  |
| **Judgment** | a thematic conjecture by Authority over inflated Conflicts       | conflicts, authority | '=.'  |

*** Types of Modelled Conflicts

| Term                | Definition                                                       | Mark |
| ---                 | ---                                                              | ---  |
| **Contradiction**   | neglected or refused to state apparent inconsistency or conflict | '?x' |
| **Deception**       | intentionally emphasized relevant half-truths to affect judgment | '?d' |
| **Distortion**      | reported relevant information in a suggestive and biased manner  | '?s' |
| **Fairness**        | neglected or refused to consider both claim and counterclaim     | '?a' |
| **Fraud**           | stated intentionally falsified relevant and crucial information  | '?u' |
| **Isolation**       | neglected or refused to consider relevant and essential context  | '?i' |
| **Extortion**       | stated relevant and threatening claims to force money or "fees"  | '?e' |
| **Misreading**      | stated seemingly unintentionally misinterpreted relevant claims  | '?m' |
| **Negligence**      | reported relevant and damaging information in a careless manner  | '?n' |
| **Omission**        | neglected or refused to report disclosed relevant information    | '?o' |
| **Proportionality** | neglected or refused to report in balanced/proportional manner   | '?y' |

*** Types of Modelled Judgments

| Term            | Definition                                                         | Mark |
| ---             | ---                                                                | ---  |
| **Bias**        | selection and judgment of conflicts satisfying a prior narrative   | '=b' |
| **Confusion**   | selection and judgment of conflicts leading to clear contradiction | '=c' |
| **Disregard**   | avoidance of relevant conflicts while protecting a prior narrative | '=g' |
| **Fabrication** | injection of disputable conjecture reinforcing a prior narrative   | '=f' |
| **Validation**  | selection and judgment of conflicts refuting an inflated Conflict  | '=v' |
