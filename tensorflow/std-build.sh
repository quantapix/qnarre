     ...
     if [ ! -e .qpx.flag ]; then
         (cd ../upstream || exit
          ...
          if [ "$2" ]; then
              ...
              export LD_LIBRARY_PATH=/home/qpix/clone/qnarre_new/.nvenv/cuda/lib64:/home/qpix/clone/qnarre_new/.nvenv/nccl/lib:/home/qpix/clone/qnarre_new/.nvenv/tensorrt/lib
          else
              # export CC_OPT_FLAGS="-march=native $CC_OPT_FLAGS"
              export TF_NEED_GDR=0
              export TF_NEED_VERBS=0
