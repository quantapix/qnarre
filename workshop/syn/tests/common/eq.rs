...
spanless_eq_struct!(Impl; defaultness unsafety gens constness polarity of_trait self_ty items);
...
spanless_eq_struct!(Trait; unsafety is_auto gens bounds items);
