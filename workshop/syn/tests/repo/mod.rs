...
static EXCLUDE_FILES: &[&str] = &[
    ...
    "tests/ui/const-gens/early/closing-args-token.rs",
    "tests/ui/const-gens/early/const-expression-parameter.rs",
    "tests/ui/parser/vari-ffi-syntactic-pass.rs",
    ...
    "tests/ui/gens/issue-94432-garbage-ice.rs",
...
fn download_and_unpack() -> Result<()> {
    let url = format!("https://github.com/rust-lang/rust/archive/{}.tar.gz", REVISION);
