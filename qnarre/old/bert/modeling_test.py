...
class BertModelTest(tf.test.TestCase):
    class BertModelTester(object):
        ...
        def create_model(self):
            input_ids = BertModelTest.ids_tensor([self.batch_size, self.seq_length], self.s_vocab)

            input_mask = None
            if self.use_input_mask:
                input_mask = BertModelTest.ids_tensor([self.batch_size, self.seq_length], s_vocab=2)
        ...
        def check_output(self, result):
            self.parent.assertAllEqual(
                ...
                [self.batch_size, self.seq_length, self.d_hidden],
            )
            ...
            self.parent.assertAllEqual(
                result["pooled_output"].shape, [self.batch_size, self.d_hidden]
            )
    ...
    @classmethod
    def ids_tensor(cls, shape, s_vocab, rng=None, name=None):
        ...
        for _ in range(total_dims):
            values.append(rng.randint(0, s_vocab - 1))
