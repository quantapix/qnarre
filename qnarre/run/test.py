...
class ExamplesTests(TestCasePlus):
    def test_run_glue(self):
        ...
        testargs = f"""
            ...
            --eval_file ./tests/fixtures/tests_samples/MRPC/dev.csv
            --do_train
            --do_eval
            --train_batch_size=2
            --eval_batch_size=1
    ...
    def test_run_clm(self):
        ...
        testargs = f"""
            ...
            --eval_file ./tests/fixtures/sample_text.txt
            --do_train
            --do_eval
            --block_size 128
            --train_batch_size 5
    ...
    def test_run_clm_config_overrides(self):
        ...
        testargs = f"""
            ...
            --train_file ./tests/fixtures/sample_text.txt
            --out_dir {tmp_dir}
            --config_overrides n_embed=10,n_heads=2
            """.split()
        ...
        self.assertIn('"n_embed": 10', cl.out)
        self.assertIn('"n_heads": 2', cl.out)
    ...
    def test_run_ner(self):
        ...
        testargs = f"""
            ...
            --eval_file tests/fixtures/tests_samples/conll/sample.json
            --out_dir {tmp_dir}
            --overwrite_out_dir
            --do_train
            --do_eval
    ...
    def test_run_squad(self):
        ...
        testargs = f"""
            ...
            --eval_file tests/fixtures/tests_samples/SQUAD/sample.json
            --out_dir {tmp_dir}
            --overwrite_out_dir
            --max_steps=10
            --warmup_steps=2
    ...
    def test_run_swag(self):
        ...
        testargs = f"""
            ...
            --eval_file tests/fixtures/tests_samples/swag/sample.json
            --out_dir {tmp_dir}
            --overwrite_out_dir
            --max_steps=20
            --warmup_steps=2
    ...
    def test_run_summarization(self):
        ...
        testargs = f"""
            ...
            --eval_file tests/fixtures/tests_samples/xsum/sample.json
            --out_dir {tmp_dir}
            --overwrite_out_dir
            --max_steps=50
            --warmup_steps=8
    ...
    def test_run_translation(self):
        ...
        testargs = f"""
            run_translation.py
            --model_name sshleifer/student_marian_en_ro_6_1
            --source_lang en
            --target_lang ro
            --train_file tests/fixtures/tests_samples/wmt16/sample.json
            --eval_file tests/fixtures/tests_samples/wmt16/sample.json
            --out_dir {tmp_dir}
            --overwrite_out_dir
            --max_steps=50
            --warmup_steps=8
    ...
    def test_run_speech_recognition_seq2seq(self):
        ...
        testargs = f"""
            ...
            --out_dir {tmp_dir}
            --model_name hf-internal-testing/tiny-random-speech-encoder-decoder
            --dataset_name hf-internal-testing/librispeech_asr_dummy
            --dataset_config clean
            --train_split_name validation
            --eval_split_name validation
