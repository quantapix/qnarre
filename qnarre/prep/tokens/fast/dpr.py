...
from .bert import Tokenizer as BertFast
from ..dpr import DPRContextEncoderTokenizer, DPRQuestionEncoderTokenizer, DPRReaderTokenizer
...
class DPRContextEncoderTokenizerFast(BertFast):
    vocab_fs = VOCAB_FS
...
class DPRQuestionEncoderTokenizerFast(BertFast):
    vocab_fs = VOCAB_FS
...
class Tokenizer(Mixin, BertFast):
    vocab_fs = VOCAB_FS
