...
class Tokenizer(PreTrainedTokenizer):
    ...
    def build_inputs_with_special_tokens(self, toks_0, toks_1=None):
        ...
        if self.padding_side == "right":
            return cls + toks_0 + question_suffix + sep + toks_1 + sep
        else:
            return cls + toks_0 + sep + toks_1 + question_suffix + sep
    ...
    def create_token_type_ids_from_sequences(self, toks_0, toks_1=None):
        ...
        if self.padding_side == "right":
            return len(cls + toks_0 + question_suffix + sep) * [0] + len(toks_1 + sep) * [1]
        else:
            return len(cls + toks_0 + sep) * [0] + len(toks_1 + question_suffix + sep) * [1]
