...
pub fn walk_item<'a, V: Visitor<'a>>(visitor: &mut V, item: &'a Item) {
    ...
    match &item.kind {
        ...
        ItemKind::Fn(box Fn {
            ...
            let kind = FnKind::Fn(FnCtxt::Free, item.ident, sig, &item.vis, generics, body.as_deref());
        ...
        ItemKind::Struct(struct_definition, generics) | ItemKind::Union(struct_definition, generics) => {
            visitor.visit_generics(generics);
...
pub fn walk_expr<'a, V: Visitor<'a>>(visitor: &mut V, expression: &'a Expr) {
    ...
    match &expression.kind {
        ...
        ExprKind::AddrOf(_, _, subexpression) | ExprKind::Unary(_, subexpression) => visitor.visit_expr(subexpression),
