...
template <int, typename> struct HasNonTypeTemplateParam {};

enum { ENUM_VARIANT_1, ENUM_VARIANT_2 };

namespace JS {

template <typename T> using Alias = HasNonTypeTemplateParam<ENUM_VARIANT_1, T>;
